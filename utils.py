...
def parse_global_args(parser):
    ...
    parser.add_argument("--multi_head", default=False, action='store_true')
...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--zeroshot_dataset", type=str, default="Instruments",
    ...
    if not args.multi_head:
        ...
        for task, prompt_sample_num, data_sample_num in zip(tasks, train_prompt_sample_num, train_data_sample_num):
            if task.lower() == "seqrec":
                ...
                train_datasets.append(dataset)
                pass
            elif task.lower() == "fusionseqrec" or task.lower() == "index2item" or task.lower() == "preferenceobtain":
                pass
            else:
                raise NotImplementedError
            # train_datasets.append(dataset)
